...
.then(res=>setSubjects(res.data.length))
...
axios.get(`${BASE_URL}/api/marks/all`)   // ✅ FIXED
.then(res=>{
...
axios.get(`${BASE_URL}/api/notes/all`)   // ✅ FIXED
...
axios.post(`${BASE_URL}/api/notes/add`,{   // ✅ FIXED
title,
message
})
.then(()=>{
...
axios.get(`${BASE_URL}/api/attendance/low-attendance`)   // ✅ FIXED
.then(res=>setLowAttendance(res.data))
.catch(err=>console.log(err));
}

function loadLowMarks(){
axios.get(`${BASE_URL}/api/marks/low-marks`)   // ✅ FIXED
